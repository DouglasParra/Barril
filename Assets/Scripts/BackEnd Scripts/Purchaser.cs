...
namespace CompleteProject
{
    ...
    public class Purchaser : MonoBehaviour, IStoreListener
    {
        ...
        public static string kProductIDConsumable_5pc = "com.sdgstudio.orb_e.5powercell";
        ...
        private GameObject powercellsManager;

        void Awake() {
            // Pega o gerenciador de powercells
            powercellsManager = GameObject.Find("Scripts");
        }
        ...
        public void InitializePurchasing()
        {
            ...
            builder.AddProduct(kProductIDConsumable_5pc, ProductType.Consumable);
        ...
        public void BuyConsumable5PC()
        {
            // Buy the consumable product using its general identifier. Expect a response either 
            // through ProcessPurchase or OnPurchaseFailed asynchronously.
            BuyProductID(kProductIDConsumable_5pc);
        }

        public void BuyConsumable20PC()
        {
            // Buy the consumable product using its general identifier. Expect a response either 
            // through ProcessPurchase or OnPurchaseFailed asynchronously.
            BuyProductID(kProductIDConsumable_20pc);
        }
        public void BuyConsumable50PC()
        {
            // Buy the consumable product using its general identifier. Expect a response either 
            // through ProcessPurchase or OnPurchaseFailed asynchronously.
            BuyProductID(kProductIDConsumable_50pc);
        }
        public void BuyConsumable100PC()
        {
            // Buy the consumable product using its general identifier. Expect a response either 
            // through ProcessPurchase or OnPurchaseFailed asynchronously.
